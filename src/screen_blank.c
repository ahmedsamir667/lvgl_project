...
static lv_obj_t * create_top_bar(lv_obj_t *parent)
{
    ...
    lv_label_set_text(title, "Blank Reading");
...
lv_obj_t *scr_1 = NULL;
/* ---------- CREATE SCREEN ---------- */
void screen_blank_create(void)
{
    /* Root screen */
    scr_1 = lv_obj_create(NULL);
    // lv_scr_load(scr);
    lv_obj_set_style_bg_color(scr_1, COLOR_BG, 0);
    lv_obj_set_style_bg_opa(scr_1, LV_OPA_COVER, 0);
    lv_obj_clear_flag(scr_1, LV_OBJ_FLAG_SCROLLABLE);

    /* ----------------- LEFT SIDEBAR ----------------- */
    lv_obj_t *sidebar = lv_obj_create(scr_1);
    ...
    for(int i = 0; i < 9; i++) {
        ...
        lv_obj_set_style_line_color(line, lv_color_hex(0x324556), LV_PART_MAIN);
        /* Position */
        lv_obj_align(line, LV_ALIGN_TOP_LEFT, -5 , 535);
    ...
    lv_obj_t *content = lv_obj_create(scr_1);
    ...
    lv_obj_t *line2 = lv_line_create(scr_1);
    ...
    lv_obj_t *card_method = create_card(scr_1, lv_pct(73), 80);
    ...
    lv_obj_align(m_title, LV_ALIGN_TOP_LEFT, 6, 0);
    ...
    lv_obj_align(m_val, LV_ALIGN_TOP_LEFT, 6, 20);
    ...
    lv_obj_align(samp_lbl, LV_ALIGN_TOP_MID, -50, 0);
    ...
    lv_obj_align(samp_val, LV_ALIGN_TOP_MID, -50, 20);
    ...
    lv_obj_align(id_lbl, LV_ALIGN_TOP_RIGHT, -120, 0);
    ...
    lv_obj_align(id_val, LV_ALIGN_TOP_RIGHT, -120, 20);

    /* Right info card  */
    lv_obj_t *card_read = create_card(scr_1, lv_pct(73), 100);
    lv_obj_align(card_read, LV_ALIGN_TOP_LEFT, 250, 175);
    ...
    lv_obj_align(abs_lbl, LV_ALIGN_TOP_LEFT, 0, 0);

    lv_obj_t *abs_val = lv_label_create(card_read);
    lv_label_set_text(abs_val, "0.847");
    lv_obj_set_style_text_color(abs_val, COLOR_NUM, 0);
    lv_obj_set_style_text_font(abs_val, &lv_font_montserrat_30, 0);
    lv_obj_align(abs_val, LV_ALIGN_TOP_LEFT, 0, 20);
    ...
    lv_obj_align(ra, LV_ALIGN_TOP_RIGHT, 0, 15);


    /* Trend results card (left) */
    lv_obj_t *card_trend = create_card(scr_1, lv_pct(73), 300);
    ...
    lv_obj_align(chart, LV_ALIGN_BOTTOM_LEFT, 60, -20);
    ...
    lv_obj_t *btn_exit = lv_btn_create(scr_1);
    ...
    lv_obj_t *btn_back = lv_btn_create(scr_1);
    ...
    lv_obj_t *btn_print = lv_btn_create(scr_1);
    ...
    lv_label_set_text(lbl_print, " Next " LV_SYMBOL_NEXT);
    lv_obj_set_style_text_color(lbl_print, lv_color_white(), 0);
    lv_obj_center(lbl_print);


    lv_obj_t *bottom_bar = create_bottom_bar(scr_1);
    ...
    lv_obj_t *line3 = lv_line_create(scr_1);
