...
/* ---------- CREATE SCREEN ---------- */
void screen_bio_create(void)
{
    /* Root screen */
    scr_3 = lv_obj_create(NULL);
    // lv_scr_load(scr);
    lv_obj_set_style_bg_color(scr_3, COLOR_BG, 0);
    lv_obj_set_style_bg_opa(scr_3, LV_OPA_COVER, 0);
    lv_obj_clear_flag(scr_3, LV_OBJ_FLAG_SCROLLABLE);
    

    /* ----------------- LEFT SIDEBAR ----------------- */
    lv_obj_t *sidebar = lv_obj_create(scr_3);
    ...
    lv_obj_t *content = lv_obj_create(scr_3);
    ...
    lv_obj_t *line2 = lv_line_create(scr_3);
    ...
    lv_obj_t *search_content = lv_obj_create(scr_3);
    ...
    lv_label_set_text(scan_lbl, "Scan Method");
    ...
    lv_textarea_set_placeholder_text(search, "Enter or select scan method");
    ...
    lv_label_set_text(lb7, "Metabolic");
